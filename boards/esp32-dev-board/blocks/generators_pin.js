...
Blockly.Python['pin_analog_read'] = function(block) {
    ...
    var functionName = Blockly.Python.provideFunction_(
        'adcRead', ['def ' + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ + '(analog_pin):',
...
Blockly.Python['pin_Rgb_write'] = function(block) {
    Blockly.Python.definitions_['from_machine_import_Pin'] = 'from machine import Pin';

    var value_value = Blockly.Python.valueToCode(block, 'turn', Blockly.Python.ORDER_ATOMIC);
    var dropdown_turn = block.getFieldValue('turn');
    var dropdown_lamp = block.getFieldValue('lamp');
